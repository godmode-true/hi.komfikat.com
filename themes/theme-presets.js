  ...
  function createThemePreset({ id, label, light, dark, brand = {} }) {
    ...
    return {
      ...
      light: {
        ...
        "--sticky-bar-surface": rgba(light.surface, 0.58),
        "--chrome-bar-surface": rgba(light.surface, 0.58),
      ...
      dark: {
        ...
        "--sticky-bar-surface": rgba(dark.surfaceSolid, 0.62),
        "--chrome-bar-surface": rgba(dark.surfaceSolid, 0.62),
  ...
  const presets = {
    ...
    "default-rose-2": createThemePreset({
      ...
      light: {
        ...
        accentSoft: "#f2c2d6",
        shellSurface:
          "linear-gradient(180deg, rgba(255, 248, 252, 0.94) 0%, rgba(255, 248, 252, 0) 20%), linear-gradient(180deg, #fcf2f8 0%, #f4e6f0 100%)",
        scrollbarTrack: "#f2e0ea",
        scrollbarThumb: "#e2a4bc",
        scrollbarThumbHover: "#d890ac",
        caret: "#d07090",
      },
      dark: {
        pageBg: "#261922",
